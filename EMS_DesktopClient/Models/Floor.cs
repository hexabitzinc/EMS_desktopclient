...
{
    public partial class Floor : BindableBase
    {
        ...
        [Column(name: "FloorIndex", TypeName = "INT")]
        public int FloorIndex
        {
            get { return this.floorIndex; }
            set { SetProperty(ref this.floorIndex, value, "FloorIndex"); }
        }
